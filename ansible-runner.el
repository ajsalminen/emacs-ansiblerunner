...
(compile (concat "ansible-playbook -i /home/anttis/projektit/vagrant/vagrant_ansible_dev/inventory -l monihaku " playbook t)))
)
...
(compile (concat "ansible-playbook -i " ansiblerunner-inventory " -l "
